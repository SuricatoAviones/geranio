  ...
  <form action="controlador/c_empleados.php" method="POST">
     ...
     <div class="col-11 col-md-6 mx-auto">
      ...
      <div class="col-11 col-md-6 mx-auto">
          ...
          <input class="form-control border-success" type="text" name="telefono" value="<?php if (isset($_POST['telefono'])) {echo $_POST['telefono'];}?>"><br>
      </div> 
      <div class="col-11 col-md-6 mx-auto">
          <label class="form-label"><b>Correo electronico</b></label>
          <input class="form-control border-success" type="email" name="correo_electronico" value="<?php if (isset($_POST['correo_electronico'])) {echo $_POST['correo_electronico'];}?>"><br>
      </div>
      <div class="col-11 col-md-6 mx-auto">
          <label class="form-label"><b>Cargo <h11>*</h11></b></label>
          <input class="form-control border-success" type="text" required name="cargo" value="<?php if (isset($_POST['cargo'])) {echo $_POST['cargo'];}?>"><br>
      </div>
      <div class="col-11 col-md-6 mx-auto">
          <label class="form-label"><b>Rif <h11>*</h11></b></label>
